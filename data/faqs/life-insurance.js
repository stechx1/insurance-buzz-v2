export const lifeInsuranceItems = [
  {
    ...
    children: (
      <div className='space-y-2'>
        ...
        <p>
          b. Permanent life insurance - also referred to as whole life
          insurance, provides coverage for the entirety of your life span. This
          type of insurance policy often includes an investment or cash value
          feature, resulting in a lump sum payment that is exempt from taxation.
        </p>
        ...
        <p>
          ...
          obligations like estate taxes, the care of a disabled family member,
          ensuring liquidity for closely-held enterprises, and even covering
          funeral costs.
        </p>
        <p>
          Through gradual payments into your permanent policy, its investment
        ...
        <p>
          ...
          component as collateral for a loan. Alternatively, you can decide to
          leave the life insurance payout to your designated beneficiaries, as
          is customary with other types of life insurance.
        </p>
        ...
        <p>
          c. Participating life insurance - constitutes a variant of whole life
          insurance coverage that offers more than just the assured death
          benefit. This policy has the potential to generate dividends, which
          are monetary distributions disbursed periodically throughout the
          policy's duration. These dividends are linked to the insurance
          company's performance and profits, typically granted to the
          policyholder on an annual basis. Essentially, this arrangement enables
          the policyholder to partake in the insurance company's profitability
          during their lifetime.
        </p>

        <p>
          These dividends are sourced from the gains yielded by the premiums
          submitted by the policyholder to the insurance company. The premiums
          from participating policies are aggregated and invested by the
          insurer. The resulting investment proceeds are then employed by the
          insurance company to fulfill benefits and cover other associated
          costs.
        </p>
        ...
        <p>
          ...
          dividends are not guaranteed, unlike the assured death benefit. Their
          distribution can vary based on the performance of investments.
        </p>

        <p>
          d. Non-participating whole life insurance - represents the most
          fundamental version of permanent insurance. It guarantees a tax-free
          death benefit and lifelong coverage, as long as you continue to pay
          the premiums. These policies feature a fixed premium, which remains
          unaffected by changes in your health once the coverage is in effect.
        </p>

        <p>
          In addition to the guaranteed death benefit, non-participating
          policies also accrue a cash value component. This cash value can be
          utilized to support various expenses during your lifetime through a
          policy loan. The cash value essentially comprises the sum of money
          that accumulates within the policy. The cash surrender value, on the
          other hand, denotes the amount paid to a policyholder if they decide
          to terminate the policy, minus any applicable surrender fees.
          Typically, the cash value experiences year-over-year growth and
          becomes accessible after a specified period of the policy, such as
          after 10 years.
        </p>

        <p>
          e. Term-to-100 insurance - schemes encompass a variety of whole life
          insurance that lacks a cash-out feature. These policies solely provide
          a payout upon your demise, rendering them somewhat more economical.
          They serve as a connection between term and whole life insurance.
          Furthermore, if you manage to reach the age of 100, you are relieved
          from the obligation to pay premiums while still maintaining the
          coverage. A multitude of individuals opt for a term-to-100 policy to
          address funeral expenses or essentially serve as a practical form of
          final expense insurance.
        </p>

        <p>
          f. Limited pay whole life insurance- stands as a type of permanent
          coverage characterized by a distinct payment structure. In this
          scenario, the life insurance company designates a condensed payment
          period, which could span 20 or 30 years, for instance. Upon completing
          premium payments within the specified timeframe, your life insurance
          policy remains assured without the need for further premium
          disbursements. It's worth noting that this policy generally entails
          elevated insurance expenses, given that the premiums are weighted
          toward the earlier years.
        </p>

        <p>
          g. Universal life insurance bears resemblance to whole life insurance,
          albeit with an additional self-directed, long-term investment facet.
          This implies that your insurance provider presents opportunities for
          investing the cash value within your policy, effectively serving as a
          means to accumulate retirement savings. For those who possess
          investment acumen or prioritize estate planning, universal life
          insurance could emerge as a more enticing choice. However, it's
          essential to note that universal life insurance policies demand more
          active management than alternative life insurance selections, and
          their investment returns might not match those offered by other
          investment avenues.
        </p>
      </div>
    ),
    ...
    children: (
      <div>
        <div className='flex flex-col gap-2'>
          <span className='font-bold'>Term Life Insurance</span>
          <p>
          ...
          <ul className='list-disc'>
            <li>Provides interim coverage over a predetermined timeframe</li>
            <li>
        ...
        <div className='flex flex-col gap-2'>
          <span className='font-bold'>Whole Life Insurance</span>
          <p>
          ...
          <ul className='list-disc'>
            <li>Offers lifelong coverage assurance</li>
            <li>
            ...
            <li>Death benefit could amplify through dividends</li>
            <li>
  ...
  },
  {
    ...
    children: (
      <div className='space-y-2'>
        ...
        <ul className='list-disc'>
          <li>How many dependents do I have?</li>
          <li>What proportion of my post-tax annual income do they rely on?</li>
          <li>Over how many years will they depend on my financial support?</li>
        </ul>
        <p>
  ...
  },
  {
    ...
    children: (
      <div className='space-y-2'>
        ...
        <p>
          Affordability: Often, an employer covers a significant portion or the
          entirety of the life insurance premium, resulting in minimal or no
          expenses for the plan member. If contributions are necessary, they
          typically come at a lower cost. This occurs because the insurance
          company calculates pricing based on the collective risk profile of the
          entire group, rather than evaluating each individual applicant.
        </p>
        <p>
          Convenience: Enrollment is simple and convenient, requiring only a
          modest amount of paperwork and without individual underwriting.
          Payments are usually deducted from payroll, eliminating concerns about
          policy lapses due to missed premiums.
        </p>
        <p>
          Limited Underwriting: In most instances, individual plan members of
          group term life contracts do not undergo medical examinations. Members
          may be enrolled automatically or voluntarily within the comprehensive
          group life insurance plan. However, in specific scenarios such as
          seeking coverage beyond the group limit or rejoining the plan after
          initial refusal, eligible employees might need to undergo medical
          underwriting to demonstrate good health.
        </p>

        <p>What are the drawbacks of group life insurance?</p>
        <p>
          Limited Coverage: Group life insurance benefits generally offer
          restricted coverage and may not adequately address your or your
          family's needs. Supplementary coverage beyond the basic group life
          insurance plan provided by your employer is likely necessary.
        </p>
        <p>
          Lack of Control: One disadvantage is the absence of control. Plan
          sponsors (employers or organizations) or even the insurance company
          can modify or terminate the plan at their discretion. Since the plan
          is shared among a group, customization to suit your unique
          requirements is not feasible. Certain medical conditions might be
          excluded.
        </p>
        <p>
          Limited Portability: Group life insurance is contingent upon an
          individual's association with the specific group. Insurance linked to
          one job doesn't guarantee the same in a new position. Should you
          require life insurance after changing careers, premiums are likely to
          rise as you're older and deemed higher risk from an underwriting
          perspective.
        </p>
        <p>
          Taxation: Depending on your employer's structure of benefit fees, the
          payout might be subject to taxes.
        </p>
      </div>
    ),
  },
  {
    ...
    children: (
      <div className='space-y-2'>
        ...
        <p>When considering a couple's pursuit of life insurance:</p>
        <p>
