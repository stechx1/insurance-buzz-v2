export const criticalIllnessItems = [
  {
    key: '1',
    label: '1. Which illnesses does critical illness insurance encompass?',
    children: (
      <div className='space-y-2'>
        ...
        <ul className='list-disc'>
          ...
          <li>Coma</li>
          <li>Complete Hearing Loss</li>
          <li>Loss of Self-Sufficiency</li>
          <li>Loss of Limbs</li>
        ...
        <p>*Typically covered in basic critical illness plans</p>
      </div>
    ),
  },
  {
