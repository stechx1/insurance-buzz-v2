  ...
  return (
    <div className='bg-[#62B1BCE5] px-3 py-5 pb-10'>
      ...
      <div className='flex flex-col mt-10  max-w-7xl m-auto'>
        <span className='bg-[#000080] text-white w-fit p-[0.35rem] mb-6'>Our Goals and Mission</span>
        ...
        <div className='flex lg:flex-row flex-col justify-between  mt-3 gap-4'>
          ...
          <div className='flex flex-col mt-10 gap-3 flex-1'>
            ...
            <GoalsBox text1={"Goals"} text2={"Our primary goal is to gain a comprehensive understanding of your financial situation, enabling us to offer top-notch information, services, and products of the utmost quality. Together, we strive to assist you in achieving your financial objectives"} diff />
            <GoalsBox text1={"Mission"} text2={"At InsuranceBuzz, we understand that insurance buying can be tricky and taxing. Our mission is to bring a difference in people's lives by connecting them to the financial security they can rely on for life. With our insurance advisory services, we help you invest in the right insurance plans that serve as a long-term protection for any unforeseen incident."} />
          </div>
